...
The active implementation phase is **7.3 — Learning tools**. Study tools now offers source-linked recall cards, optional practice answers, saved self-assessments and topic/review filters. This first increment uses complete saved note sections; it does not claim evaluated question generation or measured mastery. See the [Phase 7.3 evidence](docs/implementation/phase-7-3.md). Standalone Windows distribution follows the selected Phase 7.3 work. Earlier M08 qualification gaps remain open. See the [feature and architecture phase plan](docs/project-phases.md), [M08 evidence](docs/implementation/phase-6-m08.md), and [desktop direction](docs/architecture/windows-desktop-direction.md).
