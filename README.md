...
The active implementation phase is **7.3 — Learning tools**. Study tools offers source-linked recall cards plus model-generated questions and flashcards, saved self-assessments, protected question edits/history and a separate quality-review rubric. Generation uses the selected note model and preserves previous sets. Local synthetic question evaluation has run; human quality and learning outcomes remain unqualified. See the [Phase 7.3 evidence](docs/implementation/phase-7-3.md) and [question evaluation](docs/ai/phase-7-3-learning-evaluation.md). Standalone Windows distribution is the next user-selected delivery priority. Earlier M08 qualification gaps remain open. See the [feature and architecture phase plan](docs/project-phases.md), [M08 evidence](docs/implementation/phase-6-m08.md), and [desktop direction](docs/architecture/windows-desktop-direction.md).
