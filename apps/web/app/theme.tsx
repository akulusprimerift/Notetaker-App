...
export default function Theme(){
  ...
  useEffect(()=>{try{const saved=localStorage.getItem('notetaker:theme');if(saved&&['light','dark','pink','blue'].includes(saved)){setTheme(saved);document.documentElement.dataset.theme=saved;}}catch{}},[]);
