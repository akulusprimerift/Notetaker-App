...
OutFile "..\..\.local\native-qualified\Notetaker-Native-0.2.0-Setup.exe"
...
Section "Notetaker"
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\NotetakerNative" "DisplayVersion" "0.2.0"
