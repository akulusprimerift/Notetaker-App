...
(async()=>{
  ...
  try{
    ...
    let marks=[{id:'mark',run_id:'run',sample:1440000,sample_rate:48000,recording_number:1,label:'Important to me',version:1,removed:false,awaiting_audio:false}],attempts=[],terms={version:1,terms:['ATP']},conflict=true,catchups=0,failMark=true;
