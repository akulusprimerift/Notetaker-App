...
(async()=>{
  ...
  try{
    ...
    console.log('Study UI passed: marker retry identity, source reading, stable catch-up, remove/undo, glossary conflict preservation, Midnight and narrow layout.');
