...
(async()=>{
  ...
  try{
    ...
    notes.revision={id:'notes1',revision:1,created_at:lecture.created_at,profile:notes.profile,metadata:{model:'synthetic'},source_issues:[],content:{blocks:[{id:'b1',topic:'A key concept',kind:'emphasis',passages:[{id:'p1',text:'Context matters, including exceptions.',evidence_kind:'lecture_paraphrase',sources:[]}]}],issues:[],coverage:[]}};
