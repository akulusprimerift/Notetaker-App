...
| 6.8 / M08 | Active: user-selected native Qt Widgets rebuild, bundled runtimes, standalone storage, themes and course deletion. | Verify packaged launch and preserve the remaining clean-machine, hardware, endurance and restore gates. |
