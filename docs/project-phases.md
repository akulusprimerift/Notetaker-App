...
| 6.8 / M08 | Active: user-selected native Qt Widgets rebuild, bundled runtimes, standalone storage, themes and course deletion. | Native installer and installed launch verified on Windows 11 with synthetic inputs. Complete the remaining clean-machine, hardware, endurance and restore gates. |
